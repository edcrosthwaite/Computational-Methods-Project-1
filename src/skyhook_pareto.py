...
from skyhook_eval import evaluate_skyhook
...
if __name__ == "__main__":
    ...
    # ------------------------------------------------------------------
    base_params = SuspensionParams()

    g_values, metrics = sweep_skyhook(base_params, g_min=0.05, g_max=2.5, n=25)
    is_eff = pareto_front(metrics)

    print("Pareto-optimal skyhook damping scales g:")
