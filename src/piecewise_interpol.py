...
# Extract system parameters to be passed to the ODE function for solver optimization
v = params.v       # Vehicle speed [m/s]
m_u = params.mu    # Unsprung mass [kg]
m_s = params.ms    # Sprung mass [kg]
k_s = params.ks    # Suspension stiffness [N/m]
k_t = params.kt    # Tyre stiffness [N/m]
